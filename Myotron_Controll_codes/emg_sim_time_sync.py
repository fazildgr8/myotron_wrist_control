...
global prosup_clf, emg_window, curr_ts
...
emg_df = pd.read_excel('F:/The Stuffs/Awear/Final_Project/myotron_control/Myotron_Controll_codes/sim_data/prosup_norm_200s.xlsx')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        print(elapsed,' ',curr_ts,' ',prosup_clf)
        if elapsed>10000:
            break
